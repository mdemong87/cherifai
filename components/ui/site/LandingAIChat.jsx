        ...
        <section className="w-full bg-neutral-950 text-neutral-100">
            <Container>
                <div className="px-4 py-12 sm:py-16">
                    {/* Title */}
                    <div data-aos="fade-down" className="text-center space-y-3">
                    ...
                    {/* Input card */}
                    <div className="border-gradient p-0.5 rounded-2xl mt-6">
                        <div className="rounded-2xl myborder bg-neutral-800 p-4 shadow-lg ">
